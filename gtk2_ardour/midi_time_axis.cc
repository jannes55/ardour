...
MidiTimeAxisView::add_region (Temporal::timepos_t const & f, Temporal::timecnt_t length, bool commit)
{
...
bool
MidiTimeAxisView::paste (Temporal::timepos_t const & pos, const Selection& selection, PasteContext& ctx)
{
