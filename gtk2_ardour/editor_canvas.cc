...
void
Editor::drop_paths_part_two (const vector<string>& paths, timepos_t & pos, double ypos, bool copy)
{
	...
	if (tvp.first == 0) {
		...
		do_import (midi_paths, Editing::ImportDistinctFiles, ImportAsTrack, SrcBest, SMFTrackName, SMFTempoIgnore, pos, is.selected_instrument());
