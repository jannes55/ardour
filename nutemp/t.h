...
class LIBARDOUR_API Meter {
  public:
	...
	Temporal::BBT_Time   bbt_add (Temporal::BBT_Time const & bbt, Temporal::BBT_Offset const & add) const;
	Temporal::BBT_Time   bbt_subtract (Temporal::BBT_Time const & bbt, Temporal::BBT_Offset const & sub) const;
	Temporal::BBT_Offset bbt_delta (Temporal::BBT_Time const & bbt, Temporal::BBT_Time const & sub) const;

	Temporal::BBT_Time round_up_to_bar (Temporal::BBT_Time const &) const;
	Temporal::BBT_Time round_down_to_bar (Temporal::BBT_Time const &) const;
	Temporal::BBT_Time round_to_bar (Temporal::BBT_Time const &) const;

	Temporal::Beats to_quarters (Temporal::BBT_Offset const &) const;
...
class LIBARDOUR_API TempoMapPoint
{
  public:
	...
	Temporal::Beats quarters_at (Temporal::BBT_Time const &) const;

	Temporal::BBT_Time bbt_at (Temporal::Beats const &) const;
...
class LIBARDOUR_API TempoMap
{
   public:
	...
	bool set_tempo (Tempo const &, Temporal::BBT_Time const &, bool ramp = false);
	bool set_tempo (Tempo const &, superclock_t, bool ramp = false);

	bool set_meter (Meter const &, Temporal::BBT_Time const &);
	...
	Meter const & meter_at (Temporal::BBT_Time const & bbt) const;
	Tempo const & tempo_at (superclock_t sc) const;
	Tempo const & tempo_at (Temporal::Beats const &b) const;
	Tempo const & tempo_at (Temporal::BBT_Time const & bbt) const;

	Temporal::BBT_Time bbt_at (superclock_t sc) const;
	Temporal::BBT_Time bbt_at (Temporal::Beats const &) const;
	Temporal::Beats quarter_note_at (superclock_t sc) const;
	Temporal::Beats quarter_note_at (Temporal::BBT_Time const &) const;
   ...
   private:
	...
	TempoMapPoints::iterator iterator_at (Temporal::BBT_Time const &);
	...
	TempoMapPoints::const_iterator const_iterator_at (Temporal::BBT_Time const & bbt) const { return const_cast<TempoMap*>(this)->iterator_at (bbt); }
	...
	*/
	...
	TempoMapPoint & point_at (Temporal::BBT_Time const & bbt) { return *iterator_at (bbt); }
	...
	Meter const & meter_at_locked (Temporal::BBT_Time const & bbt) const { return const_point_at (bbt).metric(); }
	...
	Tempo const & tempo_at_locked (Temporal::BBT_Time const & bbt) const { return const_point_at (bbt).metric(); }
	Temporal::BBT_Time bbt_at_locked (superclock_t sc) const;
	Temporal::BBT_Time bbt_at_locked (Temporal::Beats const &) const;
	Temporal::Beats quarter_note_at_locked (superclock_t sc) const;
	Temporal::Beats quarter_note_at_locked (Temporal::BBT_Time const &) const;
	superclock_t superclock_at_locked (Temporal::Beats const &) const;
	superclock_t superclock_at_locked (Temporal::BBT_Time const &) const;
